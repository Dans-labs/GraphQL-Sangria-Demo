#!/usr/bin/env bash
#  /etc/init.d/graphql-sangria-demo

# ***** FILL IN APPROPRIATE RUN-LEVELS, START-UP AND SHUTDOWN PRIORITIES !!! ******
# chkconfig: 2345 92 58

# Provides:          graphql-sangria-demo
# Short-Description: Starts the graphql-sangria-demo service
...
CLASS="nl.knaw.dans.graphql.graphql.sangria.demo.ServiceStarter"
ARGS=""
USER="$NAME"
