...
import org.scalatra.CorsSupport.{ AllowCredentialsKey, AllowedHeadersKey, AllowedMethodsKey, AllowedOriginsKey }
import org.scalatra.{ LifeCycle, ScalatraServlet }
import org.scalatra.servlet.ScalatraListener

import scala.util.Try

class GraphQLSangriaDemoService(serverPort: Int,
            ...
            override def probeForCycleClass(classLoader: ClassLoader): (String, LifeCycle) = {
              ("anonymous", new LifeCycle {
                override def init(context: ServletContext): Unit = {
                  ...
                  context.initParameters(AllowedHeadersKey) = "Content-Type,Accept"
